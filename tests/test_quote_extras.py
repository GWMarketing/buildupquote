...
class QuoteExtrasTestCase(unittest.TestCase):
    ...
    def test_builder_walkthrough_recorder_renders_staged_flow(self):
        ...
        for needle in ("Record Walkthrough", "Stop &amp; Review Scope", "startWalkthrough",
                       ...
                       "BQWalkthroughParser", "/static/js/trade_catalog.js", "Add Selected to Quote",
                       "Add to Quote &amp; Scope Next Room", "rec.continuous = true",
                       ...
                       "roomGroups", "door-open", "Diagnostics", "alert-triangle",
                       "overflow-y-auto", "max-h-[88vh]", "problems", "skipped_items",
                       "client_scope_notes", "internal_crew_notes", "quote_title",
                       "General Area", "Internal job-site / crew notes",
                       "/static/js/construction_dictionary.js",
